...
import { parseEmoji, removeSkinToneModifier } from "./helpers/emjoi-helpers";
...
const ListFooterComponent = ({
  ...
  <View
    style={
      categoryPosition === "floating" ? styles.footerFloating : styles.footer
    }
  />
);

const EmojiCategoryComponent = ({
  item: { title, data },
...
EmojiCategoryComponent.displayName = "EmojiCategory";

export const EmojiCategory = React.memo(
  EmojiCategoryComponent,
  (prevProps, nextProps) => {
    if (prevProps.activeCategoryIndex !== nextProps.activeCategoryIndex)
      return false;
